    ...
    return (
        <nav className="navbar w-full mt-5 flex flex-col gap-y-2 px-10">
            <div className="flex items-center justify-between w-full mb-6">
                <Link to="/manager_home" className="flex flex-row items-center gap-x-2">
                    <div className="flex">
                        <img
                            src={logo}
                            alt={"logo"}
            ...
            <div className="flex flex-start">
                {showBack && (
                    <button onClick={() => navigate(-1)} className="back-button">
                        <span className="font-bold cursor-pointer bg-blue-light hover:bg-blue-light-hover text-black py-1 px-4 rounded mt-6">&larr;</span>
                    </button>
                )}
            </div>
        </nav>
